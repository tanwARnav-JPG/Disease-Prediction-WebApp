...
with st.sidebar:
    ...
    selected = option_menu('MENU-DRIVEN MULTIPLE DISEASE PREDICTION SYSTEM USING ML',
                          ...
                          icons=['activity','heart', 'heart-fill', 'person', 'gender-female', 'lungs'],
                          default_index=0)
...
set_bg_from_url("https://images.everydayhealth.com/homepage/health-topics-2.jpg?w=768", opacity=0.8)
