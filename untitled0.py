...
diabetes_model1 = pickle.load(open('C:/Users/arnav/Desktop/Major Project/Major Project/Trained Model/diabetes_model1.sav', 'rb'))
...
breastcancer_model = pickle.load(open('C:/Users/arnav/Desktop/Major Project/Major Project/Trained Model/breast_cancer_model (2).sav', 'rb'))
lungcancer_model = pickle.load(open('C:/Users/arnav/Desktop/Major Project/Major Project/Trained Model/lungcancer_model.sav', 'rb'))
liver_model = joblib.load(open('C:/Users/arnav/Desktop/MAJOR/liver_model.sav', 'rb'))
...
with st.sidebar:
    selected = option_menu(
        'MENU-DRIVEN MULTIPLE DISEASE PREDICTION SYSTEM USING ML',
...
if selected == 'CHOOSE AN OPTION':
    ...
    st.success("👨🏻‍💻 WELCOME TO MY ML BASED HEALTH PREDICTION WEB-APP.")
